...
{
    public static class ImagePathing_Old
    {
        ...
        /// <summary>
        /// Renames images based on their tags
        /// </summary>
        ...
        private static Dictionary<string, Dictionary<string, HashSet<WallpaperData.ImageData>>> GetRenameData(WallpaperData.ImageData[] images, DirectoryInfo moveDirectory, out int failedToNameCount)
        {
            ...
            {
                string desiredName = image.GetTaggedName().Replace(' ', '_'); // generates the desired name whilst replacing spaces with _
